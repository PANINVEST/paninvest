...
const cardBlog = [
    {title:"Trusted Partner", subtitle:"+91-7803824810", icon:"flaticon-phone-call-1"},
    {title:"Mail", subtitle:"support@PanINvest.com", icon:"flaticon-email"},
    {title:"Our Address", subtitle:"192-B , Modern Valley,   Mohali , India", icon:"flaticon-pin"},
];
                                            ...
                                            <div className="row sp15">
                                                <div className="col-md-6">
                                                    ...
                                                    <div className="input-group">
                                                        <input name="dzFirstName" required type="text" className="form-control" placeholder="Kunal" />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <label className="form-label">Last Name</label>
                                                    <div className="input-group">
                                                        <input name="dzLastName" required type="text" className="form-control" placeholder="Pidiha" />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <label className="form-label">Email address</label>
                                                    <div className="input-group">
                                                        <input name="dzEmail" required type="text" className="form-control" placeholder="abc@example.com" />
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                ...
                                                <div className="col-md-12">
                                                    ...
                                                    <div className="input-group">
                                                        <textarea name="dzMessage" rows="7" required className="form-control" placeholder="Hey !! All Good?"></textarea>
                                                    </div>
                                                </div>
                                                <div className="col-md-12">
