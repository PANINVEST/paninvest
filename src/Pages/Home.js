...
import StartupsSlider from '../components/Home/StartupsSlider';
...
//images
import main from './../assets/images/main-slider/pic1.jpg';
        ...
        <>
            <div className="page-content bg-white">	
                        ...
                        <div className="row banner-inner">
                            <div className="col-lg-8 col-md-7">
                                <div className="banner-content">
                                    <h5 className="sub-title text-primary">PanINVEST</h5>
                                    <h1 className="title">
                                        We help Scaling Startups
                                    </h1>
                ...
                <div className="content-inner-3 section-pattren1">
                    <div className="container">
                        <div className="section-head text-center wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <h2 className="title">Explore Our Startups <br/> Featured Categories</h2>
                            <p>Here is the list of all the categories of Startups on our website.</p>
                        </div>
                        <CategoriesSlider />    
                    </div>
                ...
                <section className="content-inner-3 section-pattren1">
                    <div className="container">
                        <div className="section-head text-center wow fadeInUp mb-60 mt-30" data-wow-delay="0.1s" >
                            
                            <h2 className="title">Meet Our Future Unicorns</h2>
                            <p>The unicorn story of 2021 is the one with many firsts, as the ecosystem witnessed the entry of the first healthtech, social commerce, epharmacy unicorns. The total count of Indian tech startups that have entered the unicorn club to date stands 82.</p>
                        </div>
                        <StartupsSlider />    
                    </div> 
                ...
                <section className="content-inner-3 overflow-hidden section-pattren1">
                    <div className="container">
                        <div className="section-head text-center wow fadeInUp" data-wow-delay="0.2s">
                            <h2>Recent CrowdFunding</h2>
                            <p>Here are the our listed crowdfuding startups</p>
                        </div>
                ...
                <section className="testimonial-wrapper1 content-inner">
                    <div className="section-head text-center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <p>Checkout what our Customers says</p>
                    </div>
                    <TestimonialSlider />
                </section>
