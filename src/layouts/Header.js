                    ...
                    <div className="container">
                        <div className="dz-topbar-inner d-flex justify-content-between align-items-center">
                            <div className="dz-topbar-left">
                                <ul>
                                    <li>Welcome to PanINVEST , All in one solution for Startups</li>
                                    <li>
                            ...
                            <div className="dz-topbar-right">
                                <ul>
                                    <li><i className="fas fa-phone"></i>+91-8240083870</li>
                                    <li><i className="fas fa-envelope"></i>paninvest@gmail.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className={`sticky-header main-bar-wraper navbar-expand-lg ${headerFix ? "is-fixed" : ""}`}>
                    <div className="main-bar clearfix ">
                        <div className="container clearfix">
                            <div className="logo-header mostion logo-dark fs-3 text">
                                <Link to={"/"}><a href=''>Pan<strong>INVEST</strong></a></Link>
                            </div>                        
                            <button                                 
