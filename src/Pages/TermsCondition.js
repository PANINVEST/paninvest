                        ...
                        <div className="row dz-terms">
                            ...
                            <div className="col-xl-8 col-lg-7">					
                                ...
                                <div className="dz-terms-content" id="scrollNavSection10">
                                    ...
                                    <p>If you have any questions or comments regarding these Member Terms, please contact us at <strong><a className="text-dark gmail" target="_blank" rel="noreferrer" href="mailto:PanInvests@gmail.com">PanInvests@gmail.com</a></strong></p>
                                </div>                                
                            </div>
                        </div>
                    </div>
