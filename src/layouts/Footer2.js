        ...
        <>
            <footer className="site-footer style-2" id="footer">
                        ...
                        <div className="row">
                            <div className="col-xl-4 col-lg-12 col-md-12 " >
                                <div className="widget widget_about">
                                    ...
                                    <p>PanINvest is a Crowdfunding & Charity Website by PanInvest lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et</p>
                ...
                <div className="footer-bottom text-center">
                    <div className="container">
                        <span className="copyright-text">PanINvest Crowdfunding & Charity Website - © 2023 by <a href="https://PanInvestcom/"  rel="noreferrer" target="_blank">PanInvest</a></span>
                    </div>
                </div>
            </footer>
        </>
